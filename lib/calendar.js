...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_742fe95e_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Calendar_vue__ = __webpack_require__(72);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_742fe95e_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Calendar_vue__["a" /* default */],
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  methods: {
    ...
    dateIsEnabled: function dateIsEnabled(date) {
      var enabled = true;
    ...
    getDateRange: function getDateRange() {
      ...
      for (var p = 0; p < this.pane; p++) {
        ...
        var firstDayWeek = (7 - this.firstDayOfWeek + currMonthFirstDay.getDay() + 1) % 7;
        if (firstDayWeek === 0) {
          firstDayWeek = 7;
        }
        ...
        if (this.dateRange[p].length < 42) {
          ...
          for (var _i3 = 1; _i3 <= nextMonthNeed; _i3++) {
            _date = new Date(nextMonth.year, nextMonth.month, _i3);
            this.dateRange[p].push({
              text: _i3,
              date: _date,
              sclass: this.dateIsEnabled(_date) ? 'datepicker-item-gray' : 'datepicker-item-disable'
            });
          }
        }
      }
